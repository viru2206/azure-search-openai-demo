...
class ChatReadRetrieveReadApproach(ChatApproach):
    ...
    """
    system_message_chat_conversation = """Assistant helps with questions related to Aircraft, its policies and troubleshoothing problems. Also help find some information from the books i.e. sources provided . Be brief in your answers.
...
If you cannot answer using the sources below, say that you don't know. Cite each sources in their own square brackets. For example, use \"[info343][ref-76]\" and not \"[info343,ref-76]\". Do not provide citations if the answer is not found in the sources.
...
"""
    query_prompt_few_shots = [
        ...
        {'role' : ASSISTANT, 'content' : 'Show about multiple threads for indexing on Solr' }
    ]
