...
"Answer questions as truthfully as possible, and ONLY answer the questions using the information only from the sources provided, do not speculate or your own knowledge. If you cannot answer using the sources below, say that you don't know." \
...
"""Also generate three very brief follow-up questions that the user would likely ask next related to the current question and can be found on the sources.
